         ...
         <?php
            if ($value['status']==1) {
              ...
              <a href="ca.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="Activeted" class="btn btn-success"></a>
                <a href="logod.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="Delete" class="btn btn-danger"></a>
              <?php
            }
            else {
              ?>
              <a href="ca.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="DeActived" class="btn btn-primary"></a>
                <a href="logod.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="Delete" class="btn btn-danger"></a>
              <?php
            }
          ?>
